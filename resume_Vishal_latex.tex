...
\textit{Production Support Copilot}

\pt Building an Agentic AI based \textbf{Copilot} for assisting and automating production support activities by reducing MTTR and operation toil leveraging the reasoning capabilities of LLMs \\
\pt The tool assists engineers in diagnosing alerts, user support requests, and incidents by leveraging GS specific knowledge from runbooks and recommends a resolution plan for execution with human-in-the-loop \\
...
\position{Winner - Goldman Sachs Global Engineering Hackathon - Earn Money category}{Oct '25}
\pt Engineered a \textbf{multi-agent AI system} to automate investment research by synthesizing fundamental (SEC 10-K filings), news sentiment, and technical analyses for 19 equities across five major sectors \\
\pt Designed and implemented a novel recommendation engine that aggregates signals from the specialized AI agents using a confidence-weighted ensemble model and a multi-agent debate framework, ensuring evidence-backed investment decisions \\
...
\begin{minipage}[t]{.8\textwidth}
	\pt Mentored \textbf{10} women students from low-income communities who are pursuing UG degrees across India by providing them virtual mentorship through Goldman Sachs Catalyst program
\end{minipage}%
