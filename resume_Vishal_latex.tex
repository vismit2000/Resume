...
\begin{center}
    ...
    \small +91-6378775444 $|$ \href{mailto:f20170080@pilani.bits-pilani.ac.in}{\underline{f20170080@pilani.bits-pilani.ac.in}} $|$ 
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.E.(Hons.) Computer Science, GPA: 3.68 (9.20/10)}{Aug 2017 -- May 2021}
    \resumeSubheading
      {Kendriya Vidyalaya No.1, Harni Road, Vadodara}{Gujarat, India}
      {Intermediate, 94.6\%}{April 2016 -- May 2017}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Working in Platform Solutions team at Nutanix}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Indian Institute of Remote Sensing (IIRS, ISRO)}{Uttrakhand, India}
      \resumeItemListStart
        \resumeItem{Developed a \href{https://github.com/vismit2000/IIRS_Internship}{\underline{web platform}} to identify potential suitable habitat for swamp deer in Jhilmil Jheel region near Haridwar (Uttarakhand)}
        \resumeItem{The platform also had a feature of reclassifying images on the fly on the basis of suitability}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C/C++, Java, Python, HTML/CSS, SQL, JavaScript} \\
